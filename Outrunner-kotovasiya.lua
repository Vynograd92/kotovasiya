...
--Переменные сценария по умолчанию
function getScenarioVariables()
    return {
    -- ХАРАКТЕРИСТИКИ ЮНИТОВ
	{ name = 'UNIT_HIRE_TIER_MAX', value = 0 }, -- Покупка отстроенных юнитов в своих городах (1-5 тир)
    -- Империя
    { name = 'EMPIRE_DAMAGE1_MULTI', value = 100 }, -- Империя: модификатор прямого урона (первичная атака)
    { name = 'EMPIRE_DAMAGE2_MULTI', value = 100 }, -- Империя: модификатор прямого урона (вторичная атака)
    { name = 'EMPIRE_HEAL1_MULTI', value = 100 }, -- Империя: модификатор лечения (первичная атака)
    { name = 'EMPIRE_HEAL2_MULTI', value = 100 }, -- Империя: модификатор лечения (вторичная атака)
    { name = 'EMPIRE_POWER1_MULTI', value = 100 }, -- Империя: точность (первичная атака)
    { name = 'EMPIRE_POWER2_MULTI', value = 100 }, -- Империя: точность (вторичная атака)
    { name = 'EMPIRE_INITIATIVE_MULTI', value = 100 }, -- Империя: инициатива
    { name = 'EMPIRE_ARMOR_FLAT', value = 100 }, -- Империя: броня
    { name = 'EMPIRE_REGEN_FLAT', value = 100 }, -- Империя: регенерация
    { name = 'EMPIRE_DRAIN1_FLAT', value = 100 }, -- Империя: вампиризм (первичная атака)
    { name = 'EMPIRE_DRAIN2_FLAT', value = 100 }, -- Империя: вампиризм (вторичная атака)
    { name = 'EMPIRE_CRITDAMAGE1_FLAT', value = 100 }, -- Империя: критический урон (первичная атака)
    { name = 'EMPIRE_CRITDAMAGE2_FLAT', value = 100 }, -- Империя: критический урон (вторичная атака)
    { name = 'EMPIRE_CRITPOWER1_FLAT', value = 100 }, -- Империя: шанс критического урона (первичная атака)
    { name = 'EMPIRE_CRITPOWER2_FLAT', value = 100 }, -- Империя: шанс критического урона (вторичная атака)
	{ name = 'EMPIRE_MOVEMENT_FLAT', value = 100 }, -- Империя: скорость перемещения
    { name = 'EMPIRE_SCOUT_FLAT', value = 100 }, -- Империя: дальность обзора
    { name = 'EMPIRE_TRADEDISCOUNT_FLAT', value = 100 }, -- Империя: скидка у торговцев
    { name = 'EMPIRE_NEGOTIATE_FLAT', value = 100 }, -- Империя: сопротивление действиям воров
    { name = 'EMPIRE_XPGAIN_MULTI', value = 100 }, -- Империя: получаемый отрядом опыт в бою
	
    -- Горные Кланы
    { name = 'CLANS_DAMAGE1_MULTI', value = 100 }, -- Горные Кланы: модификатор прямого урона (первичная атака)
    { name = 'CLANS_DAMAGE2_MULTI', value = 100 }, -- Горные Кланы: модификатор прямого урона (вторичная атака)
    { name = 'CLANS_HEAL1_MULTI', value = 100 }, -- Горные Кланы: модификатор лечения (первичная атака)
    { name = 'CLANS_HEAL2_MULTI', value = 100 }, -- Горные Кланы: модификатор лечения (вторичная атака)
    { name = 'CLANS_POWER1_MULTI', value = 100 }, -- Горные Кланы: точность (первичная атака)
    { name = 'CLANS_POWER2_MULTI', value = 100 }, -- Горные Кланы: точность (вторичная атака)
    { name = 'CLANS_INITIATIVE_MULTI', value = 100 }, -- Горные Кланы: инициатива
    { name = 'CLANS_ARMOR_FLAT', value = 100 }, -- Горные Кланы: броня
    { name = 'CLANS_REGEN_FLAT', value = 100 }, -- Горные Кланы: регенерация
    { name = 'CLANS_DRAIN1_FLAT', value = 100 }, -- Горные Кланы: вампиризм (первичная атака)
    { name = 'CLANS_DRAIN2_FLAT', value = 100 }, -- Горные Кланы: вампиризм (вторичная атака)
    { name = 'CLANS_CRITDAMAGE1_FLAT', value = 100 }, -- Горные Кланы: критический урон (первичная атака)
    { name = 'CLANS_CRITDAMAGE2_FLAT', value = 100 }, -- Горные Кланы: критический урон (вторичная атака)
    { name = 'CLANS_CRITPOWER1_FLAT', value = 100 }, -- Горные Кланы: шанс критического урона (первичная атака)
    { name = 'CLANS_CRITPOWER2_FLAT', value = 100 }, -- Горные Кланы: шанс критического урона (вторичная атака)
	{ name = 'CLANS_MOVEMENT_FLAT', value = 100 }, -- Горные Кланы: скорость перемещения
    { name = 'CLANS_SCOUT_FLAT', value = 100 }, -- Горные Кланы: дальность обзора
    { name = 'CLANS_TRADEDISCOUNT_FLAT', value = 100 }, -- Горные Кланы: скидка у торговцев
    { name = 'CLANS_NEGOTIATE_FLAT', value = 100 }, -- Горные Кланы: сопротивление действиям воров
    { name = 'CLANS_XPGAIN_MULTI', value = 100 }, -- Горные Кланы: получаемый отрядом опыт в бою
    -- Орды Нежити
    { name = 'HORDES_DAMAGE1_MULTI', value = 100 }, -- Орды Нежити: модификатор прямого урона (первичная атака)
    { name = 'HORDES_DAMAGE2_MULTI', value = 100 }, -- Орды Нежити: модификатор прямого урона (вторичная атака)
    { name = 'HORDES_HEAL1_MULTI', value = 100 }, -- Орды Нежити: модификатор лечения (первичная атака)
    { name = 'HORDES_HEAL2_MULTI', value = 100 }, -- Орды Нежити: модификатор лечения (вторичная атака)
    { name = 'HORDES_POWER1_MULTI', value = 100 }, -- Орды Нежити: точность (первичная атака)
    { name = 'HORDES_POWER2_MULTI', value = 100 }, -- Орды Нежити: точность (вторичная атака)
    { name = 'HORDES_INITIATIVE_MULTI', value = 100 }, -- Орды Нежити: инициатива
    { name = 'HORDES_ARMOR_FLAT', value = 100 }, -- Орды Нежити: броня
    { name = 'HORDES_REGEN_FLAT', value = 100 }, -- Орды Нежити: регенерация
    { name = 'HORDES_DRAIN1_FLAT', value = 100 }, -- Орды Нежити: вампиризм (первичная атака)
    { name = 'HORDES_DRAIN2_FLAT', value = 100 }, -- Орды Нежити: вампиризм (вторичная атака)
    { name = 'HORDES_CRITDAMAGE1_FLAT', value = 100 }, -- Орды Нежити: критический урон (первичная атака)
    { name = 'HORDES_CRITDAMAGE2_FLAT', value = 100 }, -- Орды Нежити: критический урон (вторичная атака)
    { name = 'HORDES_CRITPOWER1_FLAT', value = 100 }, -- Орды Нежити: шанс критического урона (первичная атака)
    { name = 'HORDES_CRITPOWER2_FLAT', value = 100 }, -- Орды Нежити: шанс критического урона (вторичная атака)
	{ name = 'HORDES_MOVEMENT_FLAT', value = 100 }, -- Орды Нежити: скорость перемещения
    { name = 'HORDES_SCOUT_FLAT', value = 100 }, -- Орды Нежити: дальность обзора
    { name = 'HORDES_TRADEDISCOUNT_FLAT', value = 100 }, -- Орды Нежити: скидка у торговцев
    { name = 'HORDES_NEGOTIATE_FLAT', value = 100 }, -- Орды Нежити: сопротивление действиям воров
    { name = 'HORDES_XPGAIN_MULTI', value = 100 }, -- Орды Нежити: получаемый отрядом опыт в бою
    -- Легионы Проклятых
    { name = 'LEGIONS_DAMAGE1_MULTI', value = 100 }, -- Легионы Проклятых: модификатор прямого урона (первичная атака)
    { name = 'LEGIONS_DAMAGE2_MULTI', value = 100 }, -- Легионы Проклятых: модификатор прямого урона (вторичная атака)
    { name = 'LEGIONS_HEAL1_MULTI', value = 100 }, -- Легионы Проклятых: модификатор лечения (первичная атака)
    { name = 'LEGIONS_HEAL2_MULTI', value = 100 }, -- Легионы Проклятых: модификатор лечения (вторичная атака)
    { name = 'LEGIONS_POWER1_MULTI', value = 100 }, -- Легионы Проклятых: точность (первичная атака)
    { name = 'LEGIONS_POWER2_MULTI', value = 100 }, -- Легионы Проклятых: точность (вторичная атака)
    { name = 'LEGIONS_INITIATIVE_MULTI', value = 100 }, -- Легионы Проклятых: инициатива
    { name = 'LEGIONS_ARMOR_FLAT', value = 100 }, -- Легионы Проклятых: броня
    { name = 'LEGIONS_REGEN_FLAT', value = 100 }, -- Легионы Проклятых: регенерация
    { name = 'LEGIONS_DRAIN1_FLAT', value = 100 }, -- Легионы Проклятых: вампиризм (первичная атака)
    { name = 'LEGIONS_DRAIN2_FLAT', value = 100 }, -- Легионы Проклятых: вампиризм (вторичная атака)
    { name = 'LEGIONS_CRITDAMAGE1_FLAT', value = 100 }, -- Легионы Проклятых: критический урон (первичная атака)
    { name = 'LEGIONS_CRITDAMAGE2_FLAT', value = 100 }, -- Легионы Проклятых: критический урон (вторичная атака)
    { name = 'LEGIONS_CRITPOWER1_FLAT', value = 100 }, -- Легионы Проклятых: шанс критического урона (первичная атака)
    { name = 'LEGIONS_CRITPOWER2_FLAT', value = 100 }, -- Легионы Проклятых: шанс критического урона (вторичная атака)
	{ name = 'LEGIONS_MOVEMENT_FLAT', value = 100 }, -- Легионы Проклятых: скорость перемещения
    { name = 'LEGIONS_SCOUT_FLAT', value = 100 }, -- Легионы Проклятых: дальность обзора
    { name = 'LEGIONS_TRADEDISCOUNT_FLAT', value = 100 }, -- Легионы Проклятых: скидка у торговцев
    { name = 'LEGIONS_NEGOTIATE_FLAT', value = 100 }, -- Легионы Проклятых: сопротивление действиям воров
    { name = 'LEGIONS_XPGAIN_MULTI', value = 100 }, -- Легионы Проклятых: получаемый отрядом опыт в бою
    -- Эльфийский Союз
    { name = 'ELVES_DAMAGE1_MULTI', value = 100 }, -- Эльфийский Союз: модификатор прямого урона (первичная атака)
    { name = 'ELVES_DAMAGE2_MULTI', value = 100 }, -- Эльфийский Союз: модификатор прямого урона (вторичная атака)
    { name = 'ELVES_HEAL1_MULTI', value = 100 }, -- Эльфийский Союз: модификатор лечения (первичная атака)
    { name = 'ELVES_HEAL2_MULTI', value = 100 }, -- Эльфийский Союз: модификатор лечения (вторичная атака)
    { name = 'ELVES_POWER1_MULTI', value = 100 }, -- Эльфийский Союз: точность (первичная атака)
    { name = 'ELVES_POWER2_MULTI', value = 100 }, -- Эльфийский Союз: точность (вторичная атака)
    { name = 'ELVES_INITIATIVE_MULTI', value = 100 }, -- Эльфийский Союз: инициатива
    { name = 'ELVES_ARMOR_FLAT', value = 100 }, -- Эльфийский Союз: броня
    { name = 'ELVES_REGEN_FLAT', value = 100 }, -- Эльфийский Союз: регенерация
    { name = 'ELVES_DRAIN1_FLAT', value = 100 }, -- Эльфийский Союз: вампиризм (первичная атака)
    { name = 'ELVES_DRAIN2_FLAT', value = 100 }, -- Эльфийский Союз: вампиризм (вторичная атака)
    { name = 'ELVES_CRITDAMAGE1_FLAT', value = 100 }, -- Эльфийский Союз: критический урон (первичная атака)
    { name = 'ELVES_CRITDAMAGE2_FLAT', value = 100 }, -- Эльфийский Союз: критический урон (вторичная атака)
    { name = 'ELVES_CRITPOWER1_FLAT', value = 100 }, -- Эльфийский Союз: шанс критического урона (первичная атака)
    { name = 'ELVES_CRITPOWER2_FLAT', value = 100 }, -- Эльфийский Союз: шанс критического урона (вторичная атака)
	{ name = 'ELVES_MOVEMENT_FLAT', value = 100 }, -- Эльфийский Союз: скорость перемещения
    { name = 'ELVES_SCOUT_FLAT', value = 100 }, -- Эльфийский Союз: дальность обзора
    { name = 'ELVES_TRADEDISCOUNT_FLAT', value = 100 }, -- Эльфийский Союз: скидка у торговцев
    { name = 'ELVES_NEGOTIATE_FLAT', value = 100 }, -- Эльфийский Союз: сопротивление действиям воров
    { name = 'ELVES_XPGAIN_MULTI', value = 100 }, -- Эльфийский Союз: получаемый отрядом опыт в бою

    -- Нейтралы
    { name = 'NEUTRALS_DAMAGE1_MULTI', value = 100 }, -- Нейтралы: модификатор прямого урона (первичная атака)
    { name = 'NEUTRALS_DAMAGE2_MULTI', value = 100 }, -- Нейтралы: модификатор прямого урона (вторичная атака)
    { name = 'NEUTRALS_HEAL1_MULTI', value = 100 }, -- Нейтралы: модификатор лечения (первичная атака)
    { name = 'NEUTRALS_HEAL2_MULTI', value = 100 }, -- Нейтралы: модификатор лечения (вторичная атака)
    { name = 'NEUTRALS_POWER1_MULTI', value = 100 }, -- Нейтралы: точность (первичная атака)
    { name = 'NEUTRALS_POWER2_MULTI', value = 100 }, -- Нейтралы: точность (вторичная атака)
    { name = 'NEUTRALS_INITIATIVE_MULTI', value = 100 }, -- Нейтралы: инициатива
    { name = 'NEUTRALS_ARMOR_FLAT', value = 100 }, -- Нейтралы: броня
    { name = 'NEUTRALS_REGEN_FLAT', value = 100 }, -- Нейтралы: регенерация
    { name = 'NEUTRALS_DRAIN1_FLAT', value = 100 }, -- Нейтралы: вампиризм (первичная атака)
    { name = 'NEUTRALS_DRAIN2_FLAT', value = 100 }, -- Нейтралы: вампиризм (вторичная атака)
    { name = 'NEUTRALS_CRITDAMAGE1_FLAT', value = 100 }, -- Нейтралы: критический урон (первичная атака)
    { name = 'NEUTRALS_CRITDAMAGE2_FLAT', value = 100 }, -- Нейтралы: критический урон (вторичная атака)
    { name = 'NEUTRALS_CRITPOWER1_FLAT', value = 100 }, -- Нейтралы: шанс критического урона (первичная атака)
    { name = 'NEUTRALS_CRITPOWER2_FLAT', value = 100 }, -- Нейтралы: шанс критического урона (вторичная атака)
	{ name = 'NEUTRALS_MOVEMENT_FLAT', value = 100 }, -- Нейтралы: скорость перемещения
    { name = 'NEUTRALS_SCOUT_FLAT', value = 100 }, -- Нейтралы: дальность обзора
    { name = 'NEUTRALS_TRADEDISCOUNT_FLAT', value = 100 }, -- Нейтралы: скидка у торговцев
    { name = 'NEUTRALS_NEGOTIATE_FLAT', value = 100 }, -- Нейтралы: сопротивление действиям воров
    { name = 'NEUTRALS_XPGAIN_MULTI', value = 100 }, -- Нейтралы: получаемый отрядом опыт в бою

    -- ЭКОНОМИКА: ДОХОД ОТ ГОРОДОВ И СТОЛИЦЫ
    { name = 'EMPIRE_TIER_0_CITY_INCOME', value = 0 }, -- Империя: доход от столицы
    { name = 'EMPIRE_TIER_1_CITY_INCOME', value = 0 }, -- Империя: доход от города 1 уровня
    { name = 'EMPIRE_TIER_2_CITY_INCOME', value = 0 }, -- Империя: доход от города 2 уровня
    { name = 'EMPIRE_TIER_3_CITY_INCOME', value = 0 }, -- Империя: доход от города 3 уровня
    { name = 'EMPIRE_TIER_4_CITY_INCOME', value = 0 }, -- Империя: доход от города 4 уровня
    { name = 'EMPIRE_TIER_5_CITY_INCOME', value = 0 }, -- Империя: доход от города 5 уровня
	
    { name = 'CLANS_TIER_0_CITY_INCOME', value = 0 }, -- Горные Кланы: доход от столицы
    { name = 'CLANS_TIER_1_CITY_INCOME', value = 0 }, -- Горные Кланы: доход от города 1 уровня
    { name = 'CLANS_TIER_2_CITY_INCOME', value = 0 }, -- Горные Кланы: доход от города 2 уровня
    { name = 'CLANS_TIER_3_CITY_INCOME', value = 0 }, -- Горные Кланы: доход от города 3 уровня
    { name = 'CLANS_TIER_4_CITY_INCOME', value = 0 }, -- Горные Кланы: доход от города 4 уровня
    { name = 'CLANS_TIER_5_CITY_INCOME', value = 0 }, -- Горные Кланы: доход от города 5 уровня
	
    { name = 'HORDES_TIER_0_CITY_INCOME', value = 0 }, -- Орды Нежити: доход от столицы
    { name = 'HORDES_TIER_1_CITY_INCOME', value = 0 }, -- Орды Нежити: доход от города 1 уровня
    { name = 'HORDES_TIER_2_CITY_INCOME', value = 0 }, -- Орды Нежити: доход от города 2 уровня
    { name = 'HORDES_TIER_3_CITY_INCOME', value = 0 }, -- Орды Нежити: доход от города 3 уровня
    { name = 'HORDES_TIER_4_CITY_INCOME', value = 0 }, -- Орды Нежити: доход от города 4 уровня
    { name = 'HORDES_TIER_5_CITY_INCOME', value = 0 }, -- Орды Нежити: доход от города 5 уровня
	
    { name = 'LEGIONS_TIER_0_CITY_INCOME', value = 0 }, -- Легионы Проклятых: доход от столицы
    { name = 'LEGIONS_TIER_1_CITY_INCOME', value = 0 }, -- Легионы Проклятых: доход от города 1 уровня
    { name = 'LEGIONS_TIER_2_CITY_INCOME', value = 0 }, -- Легионы Проклятых: доход от города 2 уровня
    { name = 'LEGIONS_TIER_3_CITY_INCOME', value = 0 }, -- Легионы Проклятых: доход от города 3 уровня
    { name = 'LEGIONS_TIER_4_CITY_INCOME', value = 0 }, -- Легионы Проклятых: доход от города 4 уровня
    { name = 'LEGIONS_TIER_5_CITY_INCOME', value = 0 }, -- Легионы Проклятых: доход от города 5 уровня
	
    { name = 'ELVES_TIER_0_CITY_INCOME', value = 0 }, -- Эльфийский Союз: доход от столицы
    { name = 'ELVES_TIER_1_CITY_INCOME', value = 0 }, -- Эльфийский Союз: доход от города 1 уровня
    { name = 'ELVES_TIER_2_CITY_INCOME', value = 0 }, -- Эльфийский Союз: доход от города 2 уровня
    { name = 'ELVES_TIER_3_CITY_INCOME', value = 0 }, -- Эльфийский Союз: доход от города 3 уровня
    { name = 'ELVES_TIER_4_CITY_INCOME', value = 0 }, -- Эльфийский Союз: доход от города 4 уровня
    { name = 'ELVES_TIER_5_CITY_INCOME', value = 0 }, -- Эльфийский Союз: доход от города 5 уровня
	
    { name = 'NEUTRALS_TIER_0_CITY_INCOME', value = 0 }, -- Нейтралы: доход от столицы
    { name = 'NEUTRALS_TIER_1_CITY_INCOME', value = 0 }, -- Нейтралы: доход от города 1 уровня
    { name = 'NEUTRALS_TIER_2_CITY_INCOME', value = 0 }, -- Нейтралы: доход от города 2 уровня
    { name = 'NEUTRALS_TIER_3_CITY_INCOME', value = 0 }, -- Нейтралы: доход от города 3 уровня
    { name = 'NEUTRALS_TIER_4_CITY_INCOME', value = 0 }, -- Нейтралы: доход от города 4 уровня
    { name = 'NEUTRALS_TIER_5_CITY_INCOME', value = 0 }, -- Нейтралы: доход от города 5 уровня

    -- Универсальные бонусы ко всем расам
    { name = 'TIER_0_CITY_INCOME', value = 0 }, -- Все расы: доход от столицы
...
return {
	{
		gold = { min = gmm(100,150), max = gmm(110,175)},
		loot = {
			items = {
	...
	{
		gold = { min = gmm(110,175), max = gmm(120,192)},
		loot = {
			items = {
...
return {
	{
		gold = { min = gmm(125,200), max = gmm(137,225)},
		loot = {
			items = {
...
return {
	{
		gold = { min = gmm(150,250), max = gmm(165,275)},
		loot = {
			items = {
...
return {
	{
		gold = { min = gmm(175,275), max = gmm(192,300)},
		loot = {
			items = {
	...
	{
		gold = { min = gmm(192,300), max = gmm(210,330)},
		loot = {
			items = {
...
return {
	{
		gold = { min = gmm(210,325), max = gmm(230,355)},
		loot = {
			items = {
...
return {
	{
		gold = { min = gmm(250,400), max = gmm(275,440)},
		loot = {
			items = {
...
-- Источники т1: голда, вторая, третья/четвёртая  удалил золото для котовасии
function getMinesRespZ2(race)
	if race == Race.Human then return
		{ runicMana = 1, groveMana = tbl[1], infernalMana = tbl[2]}
	elseif race == Race.Dwarf then return
		{ lifeMana = 1, groveMana = tbl[1], deathMana = tbl[2]}
	elseif race == Race.Heretic then return
		{ deathMana = 1, groveMana = tbl[1], runicMana = tbl[2]}
	elseif race == Race.Undead then return
		{ infernalMana = 1, runicMana = tbl[1], groveMana = tbl[2]}
	elseif race == Race.Elf then return
		{ lifeMana = 1, infernalMana = tbl[1], runicMana = tbl[2]}
	end
end

-- Источники т2: голда, родная, вторая, третья/четвёртая (инверс т1), пятая  удалил золото для котовасии
function getMinesResp(race)
	if race == Race.Human then return
		{lifeMana = 1, runicMana = 1, groveMana = tbl[2], infernalMana = tbl[1], deathMana = 1}
	elseif race == Race.Dwarf then return
		{runicMana = 1, lifeMana = 1, groveMana = tbl[2], deathMana = tbl[1], infernalMana = 1}
	elseif race == Race.Heretic then return
		{infernalMana = 1, deathMana = 1, groveMana = tbl[2], runicMana = tbl[1], lifeMana = 1}
	elseif race == Race.Undead then return
		{deathMana = 1, infernalMana = 1, runicMana = tbl[2], groveMana = tbl[1], lifeMana = 1}
	elseif race == Race.Elf then return
		{groveMana = 1, lifeMana = 1, infernalMana = tbl[2], runicMana = tbl[1], deathMana = 1}
	end
end
...
function getMinesZone34(race)
	if race == Race.Human then return
		{lifeMana = 1, groveMana = tbl[1], infernalMana = tbl[2], deathMana = 1}
	elseif race == Race.Dwarf then return
		{runicMana = 1, groveMana = tbl[1], deathMana = tbl[2], infernalMana = 1}
	elseif race == Race.Heretic then return
		{infernalMana = 1, groveMana = tbl[1], runicMana = tbl[2], lifeMana = 1}
	elseif race == Race.Undead then return
		{deathMana = 1, runicMana = tbl[1], groveMana = tbl[2], lifeMana = 1}
	elseif race == Race.Elf then return
		{groveMana = 1, infernalMana = tbl[1], runicMana = tbl[2], deathMana = 1}
	end
end
...
-- Генерация юнитов для T0 (начальная зона, уникальные юниты 1 уровня без 2х клеток)
function unitsMercT0(race)
    local base_units = {
		-- империя
        'g003uu5001', 'g000uu0006', 'g000uu0011', 'g000uu0001', 'g000uu0008', 'g000uu0018',
		--гномы
        'g000uu0036', 'g000uu0026', 'g004uu5039', 'g000uu0033', 'g000uu0043', 'g000uu0029',
		-- легионы
		'g000uu0052','g000uu0062', 'g000uu0055', 'g000uu0069', 'g000uu0057',
		-- орды нежити
		'g000uu0080', 'g001uu7539', 'g000uu0086', 'g000uu0092','g000uu0078', 'g000uu0093',
		--эльфы
		'g000uu8031', 'g000uu8014', 'g000uu8025', 'g000uu8018', 'g000uu8029', 'g003uu8037'
    }
    ...
    local unitsm = {}
    local i = 1
    local excludes = race_excludes[race] or {}
    local exclude_map = {}

    for _, id in ipairs(excludes) do
        exclude_map[id] = true
    end

    for _, id in ipairs(base_units) do
        if not exclude_map[id] then
            unitsm[i] = { id = id, level = 1, unique = true }
            i = i + 1
        end
    end
...
-- Наёмники в зоне т0
function zoneMercenZone0(race)

    return {
		{	name = "Наемники Криогена",
            description = "Юнитцы для котовасии",
			
            units = unitsMercT0(race),
            guard = {
				owner = race,
                value = {  min = 1, max = 1 }, 
                name = "Курьер",
                leaderIds = { 'g000uu8193'},
                leaderModifiers = { 
					-- добавить 10 мувов (100)
					'g201um9210', 'g201um9210', 'g201um9210', 'g201um9210', 
					'g201um9210', 'g201um9210', 'g201um9210', 'g201um9210',
					-- убрать обзор -1
					'g201um9037',
					-- хождение по лесам,мореплавание и тд
					'g000um9036','g000um9037',
				},
...
function getPlayerZone00(zoneId, playerRace, zoneSize)
	...
	return {
		...
		mercenaries = zoneMercenZone0(playerRace),
